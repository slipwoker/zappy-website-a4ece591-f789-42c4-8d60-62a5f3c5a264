document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('blur', function (e) {
      ...
      if (field.matches('input, textarea, select') && field.type !== 'hidden') {
        validateField(field);
      }
    }, true);
  ...
  const animatedElements = document.querySelectorAll(ANIMATION_CLASSES.join(', '));
      ...
      entries.forEach(function (entry) {
        if (entry.isIntersecting) {
          ...
          children.forEach(function (child, index) {
            child.classList.add('animate-ready');
            setTimeout(function () {
              child.classList.add('animate-visible');
              child.classList.remove('animate-ready');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'a4ece591-f789-42c4-8d60-62a5f3c5a264',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'a4ece591-f789-42c4-8d60-62a5f3c5a264';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'a4ece591-f789-42c4-8d60-62a5f3c5a264';
